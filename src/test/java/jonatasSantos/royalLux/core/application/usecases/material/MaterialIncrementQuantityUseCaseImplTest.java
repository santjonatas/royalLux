...
class MaterialIncrementQuantityUseCaseImplTest {

    @Mock
    private MaterialRepository materialRepository;

    @InjectMocks
    private MaterialIncrementQuantityUseCaseImpl materialIncrementQuantityUseCase;
    ...
    void deveIncrementarMaterialComSucesso() {
        ...
        assertEquals(8, output.currentQuantity());
